...
function solicitarTablilla() {
  ...
  modal.innerHTML = `
    <div style="border:1px solid var(--border-gold);background:var(--bg2);padding:2.5rem;max-width:480px;width:90%;text-align:center;position:relative;">
      ...
      <div onclick="this.closest('div[style]').remove()" style="position:absolute;top:.8rem;right:.8rem;cursor:pointer;color:var(--text-muted);font-size:16px;opacity:.5;">✕</div>
